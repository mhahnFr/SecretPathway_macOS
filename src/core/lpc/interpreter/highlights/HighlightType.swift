...
enum HighlightType: String {
    ...
    STRINGS, ARRAY_TYPE, AST_FLOAT, OR_TYPE, SCOPE_CHAIN
    ...
    BIT_XOR, BIT_NOT,
    STATIC, FLOAT, FLOAT_KEYWORD, EXCEPTION, FUNCTION
    
    /// An interpretation highlight type.
    case TYPE_MISMATCH, ERROR, WARNING, NOT_FOUND, NOT_FOUND_BUILTIN, UNRESOLVED, INTERPRETER_DEPRECATED
}
